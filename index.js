...
client.connect ( err => {
    ...
    app.get ( '/', ( req, res ) => {
        res.render ( 'index', {
            title: 'WebDev Enquete',
            pageTitle: 'WebDev Minor Enquete',
            progress: 0,
            existingUuid: false
        } )
    } );
    ...
    app.post ( '/question', ( req, res ) => {
        if ( req.body.uuid ) {
            let q;
            if ( req.body.action === 'Volgende vraag' ) {
                q = nextQ ( req.body.q );
            } else if ( req.body.action === 'Vorige vraag' ) {
                q = prevQ ( req.body.q );
            } else if ( req.body.action === 'Afronden' ) {
                q = 'finish';
            }
